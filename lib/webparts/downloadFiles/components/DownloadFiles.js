...
var DownloadFiles = /** @class */ (function (_super) {
    ...
    DownloadFiles.prototype.render = function () {
        var _a = this.props, hasTeamsContext = _a.hasTeamsContext, collectionData = _a.collectionData;
        ...
        return (React.createElement("section", { className: "".concat(styles.downloadFiles, " ").concat(hasTeamsContext ? styles.teams : "") },
            React.createElement("div", { className: styles.content },
                React.createElement("div", null,
                    React.createElement("a", { href: "https://intellego365.sharepoint.com/sites/CentralAxity/M%C3%A9xico/Consultoria2/SiteAssets/files/".concat(fileName, ".pdf"), download: true, className: styles.content__dowload },
